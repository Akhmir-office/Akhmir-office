...
if (!text) return conn.reply(m.chat, `🎌 *أدخل الطلب*\n\nEjemplo, !${command} رمز JS للعبة الورق`, m, fake, ) 
  
try {

conn.sendPresenceUpdate('composing', m.chat)
let sistema1 = `ستعمل بمثابة WhatsApp Bot الذي أنشأه Alexis akhmir-MD`
...
try {
let syms1 = ` ستعمل بمثابة WhatsApp Bot الذي أنشأه Alexis akhmir-MD`
